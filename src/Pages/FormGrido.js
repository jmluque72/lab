                    ...
                    <form onSubmit={(event) => this.send_form(event)}>
                        <Grid container direction='column' alignItems='center' style={{ width: '100%', height: '100%' }}>
                            <div style={{ width: '80%', display: 'flex', flexDirection: 'column', alignItems: 'center', boxShadow: ' 0 4px 5px -2px black' }}>
                                <p style={{ marginLeft: 20, marginRight: 20, color: 'black', fontFamily: 'FiraSansRegular', fontSize: 20, textAlign: 'center' }}>Muchas gracias por ser parte del “Dia del Veterinario Zoovet”</p>
                                <p style={{ color: colors.gray, fontFamily: 'FiraSansBook', fontSize: 18, textAlign: 'center', width: '80%' }}>A continuación, vas a encontrar una serie de preguntas para comprender aquellos elementos que más valor te aportan a vos. De esta manera seguiremos diseñando eventos que cumplan todas sus expectativas.</p>
                            </div>
                                ...
                                <Grid container direction='column' style={{ width: '100%', height: '100%' }}>
                                    ...
                                    <Grid container direction={'column'} style={{ marginLeft: 5 }}>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Si</p>
                                        </Grid>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>No</p>
                                        </Grid>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Estoy interesado</p>
                                        </Grid>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>No soy veterinario/a</p>
                                        </Grid>
                                    </Grid>
                                </Grid>
                            </div>
                            <div style={{ width: '70%', background: gray, position: 'relative', borderRadius: 12, marginTop: 20, paddingLeft: '2.5%', paddingRight: '2.5%', paddingTop: 20, paddingBottom: 20 }}>
                                <Grid container direction='column' style={{ width: '100%', height: '100%' }}>
                                    <div style={{ width: '100%' }}>
                                        ...
                                        <p style={{ color: 'black', fontFamily: 'FiraSansRegular', textAlign: 'left', fontSize: 14, margin: 0, marginLeft: 5 }}>(De 1 a 5, donde 1 es muy malo, 2 malo, 3 bueno, 4 muy bueno y 5 excelente)</p>
                                    </div>
                                    <Grid container direction={!min ? 'column' : 'row'} >
                                        <Grid item sm={1} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                            <p style={{ margin: 0, fontSize: 18, color: 'black', fontFamily: 'FiraSansRegular', marginRight: 5 }}>1</p>
                                        ...
                                        <Grid item sm={1} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                            <p style={{ margin: 0, fontSize: 18, color: 'black', fontFamily: 'FiraSansRegular', marginRight: 5 }}>2</p>
                                        ...
                                        <Grid item sm={1} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                            <p style={{ margin: 0, fontSize: 18, color: 'black', fontFamily: 'FiraSansRegular', marginRight: 5 }}>3</p>
                                        ...
                                        <Grid item sm={1} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                            <p style={{ margin: 0, fontSize: 18, color: 'black', fontFamily: 'FiraSansRegular', marginRight: 5 }}>4</p>
                                        ...
                                        <Grid item sm={1} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                            <p style={{ margin: 0, fontSize: 18, color: 'black', fontFamily: 'FiraSansRegular', marginRight: 5 }}>5</p>
                                ...
                                <Grid container direction='row' style={{ width: '100%', height: '100%' }}>
                                    ...
                                    <Grid justify='start' container direction={'row'} style={{ marginLeft: 5 }}>
                                        <Grid item sm={3} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Redes sociales</p>
                                        </Grid>
                                        <Grid item sm={3} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Radios</p>
                                        </Grid>
                                        <Grid item sm={3} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Mailing</p>
                                        </Grid>
                                        <Grid item sm={3} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'start' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Distribuidores</p>
                                        </Grid>
                                        <Grid item sm={3} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'start' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Medios del sector</p>
                                        </Grid>
                                    </Grid>
                                </Grid>
                            </div>
                            ...
                            <div style={{ width: '70%', background: gray, position: 'relative', borderRadius: 12, marginTop: 20, paddingLeft: '2.5%', paddingRight: '2.5%', paddingTop: 20, paddingBottom: 20 }}>
                                <Grid container direction='column' style={{ width: '100%', height: '100%' }}>
                                    <div style={{ width: '100%' }}>
                                        ...
                                        <p style={{ color: 'black', fontFamily: 'FiraSansRegular', textAlign: 'left', fontSize: 14, margin: 0, marginLeft: 5 }}>(Ulises Bueno, Coki Ramirez,Cacho Buenaventura)</p>
                                        <p style={{ color: 'black', fontFamily: 'FiraSansRegular', textAlign: 'left', fontSize: 14, margin: 0, marginLeft: 5 }}>(De 1 a 5, donde 1 es muy malo, 2 malo, 3 bueno, 4 muy bueno y 5 excelente)</p>
                                    </div>
                                    <Grid container direction={!min ? 'column' : 'row'} >
                                        <Grid item sm={1} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                        ...
                                        <div style={{ width: '100%', marginTop: 20 }}>
                                            <p style={{ color: 'black', fontFamily: 'FiraSansBook', textAlign: 'left', fontSize: 16, margin: 0, marginLeft: 5 }}>¿Qué mejoraría?</p>
                                        </div>
                                ...
                                <Grid container direction='column' style={{ width: '100%', height: '100%' }}>
                                    ...
                                    <Grid container direction={'column'} style={{ marginLeft: 5 }}>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Show de Cacho</p>
                                        </Grid>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Show de Ulises</p>
                                        </Grid>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Show de Coqui</p>
                                        </Grid>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>La conduccion</p>
                                        </Grid>
                                        <Grid item sm={12} style={{ marginTop: 10, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: 16, color: 'black', fontFamily: 'FiraSansBook', marginLeft: 10 }}>Bloque emotivo</p>
                                        </Grid>
                                    </Grid>
                                    <div style={{ width: '100%', marginTop: 20 }}>
                            ...
                            <div style={{ width: '70%', display: 'flex', justifyContent: 'center' }}>
                                {this.state.send ?
                                    <p style={{ color: colors.gray, fontFamily: 'FiraSansRegular', fontSize: min ? 30 : 30, marginTop: 20, textAlign: 'center' }}>¡Muchas gracias por su participación!</p>
                                    :
                                    <button disabled={disabled} type='sumbit' style={{ cursor: 'pointer', border: 'none', paddingBottom: 5, paddingTop: 5, paddingLeft: 15, paddingRight: 15, marginLeft: 'auto', background: azul, borderRadius: 10, marginTop: 20 }}>
                                        <p style={{ color: 'white', fontFamily: 'FiraSansRegular', fontSize: 16, margin: 0, textAlign: 'center' }}>Enviar</p>
                                    </button>
                                }
