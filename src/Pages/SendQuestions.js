...
class SendQuestions extends React.Component {
    ...
    sendQuestion() {
        ...
        var response = fetch("https://4swa57ilx6.execute-api.sa-east-1.amazonaws.com/prod/send_question", {
            method: 'POST',
            headers: {
    ...
    sendResponse() {
        ...
        var response = fetch("https://4swa57ilx6.execute-api.sa-east-1.amazonaws.com/prod/send_response", {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
                                        ...
                                        <Grid item sm={10} xs={10} style={{ width: '65%', marginLeft: '5%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                            <select
                                                ...
                                                onChange={(event) => this.setState({ question: event.target.value })}>
                                                    <option selected id='1'>1. Semaglutida es de administración diaria y titulación semanal</option>
                                                    <option id='2'>2. Semaglutida siempre se debe iniciar con la dosis de 0,25mg/semana</option>
                                                    <option id='3'>3. La dosis de mantenimiento de semaglutida es  1mg/semana</option>
                                                    <option id='4'>4. El evento adverso más frecuente con semaglutida es la pancreatitis </option>
                                                    <option id='5'>5. El tratamiento con semaglutida produce más intolerancia digestiva que otros arGLP1</option>
                                                    <option id='6'>6. Durante el tratamiento no se puede modificar el día de aplicación de semaglutida.</option>
                                                    <option id='7'>7. Al iniciar con semaglutida debe ajustar la dosis de metformina.</option>
                                                    <option id='8'>8.Una paciente embarazada o en periodo de lactancia no debe usar semaglutida</option>
                                                    <option id='8'>9. El tratamiento con semalutida no es seguro en adultos mayores</option>
                                                    <option id='10'>10. Semaglutida puede indicarse en pacientes con insuficiencia renal leve, moderada y severa.</option>
